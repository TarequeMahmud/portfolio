...
const Header = () => {
  return (
    <header className="w-full min-w-[320px] min-h-60 max-h-120 relative border-b-2 border-[#05155e] bg-[#0170b1] bg-[url('/hero-background.jpg')] bg-center bg-cover bg-no-repeat">
      {/* Top Navigation Bar */}
